...
# does not create the messages table in the database, that is done through a migration.
...
# This model validates that the messages have a body. Messages without a body will not be able
# to be saved
